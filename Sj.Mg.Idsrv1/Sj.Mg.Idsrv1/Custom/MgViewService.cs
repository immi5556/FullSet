...
{
    public class MgViewService: IViewService
    {
        IClientStore clientStore;
        public MgViewService(IClientStore clientStore)
        {
        ...
        {
            var file = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"content\MgUi");
