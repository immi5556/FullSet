...
public class Naive
{
    ...
    static void CreatePatient()
    {
        ...
        Dictionary<string, string> parameters = new Dictionary<string, string>()
      {
        ...
        WebRequest request = WebRequest.Create(Test.Mongo.athena.Utils.PathJoin(baseUrl, auth_prefixes[version], "/token"));
        request.Method = "POST";
        ...
        string encoded = Test.Mongo.athena.Utils.UrlEncode(parameters);
    ...
    static void GetDepartment(string baseUrl, string token, string version, string practiceid)
    {
        ...
        parameters = new Dictionary<string, string>()
      {
        ...
        string url = Test.Mongo.athena.Utils.PathJoin(baseUrl, version, practiceid, "/departments", "?" + Test.Mongo.athena.Utils.UrlEncode(parameters));
    ...
    static public void Main1()
    {
        ...
        Dictionary<string, string> parameters = new Dictionary<string, string>()
      {
        ...
        url = Test.Mongo.athena.Utils.PathJoin(baseUrl, version, practiceid, "/appointments/1/notes");
        parameters = new Dictionary<string, string>()
      {
        ...
        content = UTF8.GetBytes(Test.Mongo.athena.Utils.UrlEncode(parameters));
