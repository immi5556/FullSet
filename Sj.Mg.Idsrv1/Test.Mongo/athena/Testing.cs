...
//        ////////////////////////////////////////////////////////////////////////////////////////////////
//        Newtonsoft.Json.Linq.JObject customfields = api.GET("/customfields");
...
//        Newtonsoft.Json.Linq.JObject open_appts = api.GET("/appointments/open", search);
//        Console.WriteLine(open_appts.ToString());
//        Newtonsoft.Json.Linq.JToken appt = open_appts["appointments"][0];
...
//        foreach (var kvp in ((Newtonsoft.Json.Linq.JObject)appt).Properties())
//        {
//            newAppt[kvp.Name] = kvp.Value.ToString();
//        }
...
//        Newtonsoft.Json.Linq.JObject newPatient = api.POST("/patients", patientInfo);
//        Console.WriteLine(newPatient.ToString());
//        string newPatientID = newPatient[0]["patientid"].ToString();
...
//        Newtonsoft.Json.Linq.JObject booked = api.PUT("/appointments/" + appt["appointmentid"], appointmentInfo);
...
//        ////////////////////////////////////////////////////////////////////////////////////////////////
//        Newtonsoft.Json.Linq.JObject checked_in = api.POST(string.Format("/appointments/{0}/checkin", appt["appointmentid"]));
...
//        {"departmentid", "1"},
//      };
//        Newtonsoft.Json.Linq.JObject chartAlert = api.DELETE(string.Format("/patients/{0}/chartalert", newPatientID), deleteParams);
...
//        ////////////////////////////////////////////////////////////////////////////////////////////////
//        Newtonsoft.Json.Linq.JObject photo = api.DELETE(string.Format("/patients/{0}/photo", newPatientID));
...
//        // Error conditions
//        ////////////////////////////////////////////////////////////////////////////////////////////////
//        Newtonsoft.Json.Linq.JObject badPath = api.GET("/nothing/at/this/path");
//        Console.WriteLine("GET /nothing/at/this/path:");
//        Console.WriteLine(badPath.ToString());
//        Newtonsoft.Json.Linq.JObject missingParameters = api.GET("/appointments/open");
