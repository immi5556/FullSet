    ...
    public class APIConnection
    {
            ...
            Dictionary<string, string> parameters = new Dictionary<string, string>()
        {
          {"grant_type", "client_credentials"},
            ...
            // Grab the token!
            this.token = authorization["access_token"].ToString();
        }
        ...
        private Newtonsoft.Json.Linq.JObject AuthorizedCall(WebRequest request, Dictionary<string, string> body, Dictionary<string, string> headers, bool secondcall = false)
        {
            ...
            try
            {
                ...
                response.Close();
                return Newtonsoft.Json.Linq.JObject.Parse(reply);
            }
        ...
        /// <returns>The JSON-decoded response</returns>
        public Newtonsoft.Json.Linq.JObject GET(string path, Dictionary<string, string> parameters)
        {
        ...
        /// <returns>The JSON-decoded response</returns>
        public Newtonsoft.Json.Linq.JObject GET(string path, Dictionary<string, string> parameters, Dictionary<string, string> headers)
        {
        ...
        /// <param name="path">The URI to access</param>
        /// <returns>The JSON-decoded response</returns>
        public Newtonsoft.Json.Linq.JObject POST(string path)
        {
        ...
        /// <param name="parameters">The request parameters</param>
        /// <returns>The JSON-decoded response</returns>
        public Newtonsoft.Json.Linq.JObject POST(string path, Dictionary<string, string> parameters)
        {
        ...
        /// <param name="headers">The request headers</param>
        /// <returns>The JSON-decoded response</returns>
        public Newtonsoft.Json.Linq.JObject POST(string path, Dictionary<string, string> parameters, Dictionary<string, string> headers)
        {
            string url = PathJoin(this.baseUrl, this.version, this.PracticeID, path);
            WebRequest request = WebRequest.Create(url);
            request.Method = "POST";
        ...
        /// <param name="path">The URI to access</param>
        /// <returns>The JSON-decoded response</returns>
        public Newtonsoft.Json.Linq.JObject PUT(string path)
        {
        ...
        /// <param name="parameters">The request parameters</param>
        /// <returns>The JSON-decoded response</returns>
        public Newtonsoft.Json.Linq.JObject PUT(string path, Dictionary<string, string> parameters)
        {
        ...
        /// <param name="headers">The request headers</param>
        /// <returns>The JSON-decoded response</returns>
        public Newtonsoft.Json.Linq.JObject PUT(string path, Dictionary<string, string> parameters, Dictionary<string, string> headers)
        {
            string url = PathJoin(this.baseUrl, this.version, this.PracticeID, path);
            WebRequest request = WebRequest.Create(url);
            request.Method = "PUT";
        ...
        /// <param name="path">The URI to access</param>
        /// <returns>The JSON-decoded response</returns>
        public Newtonsoft.Json.Linq.JObject DELETE(string path)
        {
        ...
        /// <param name="parameters">The request parameters</param>
        /// <returns>The JSON-decoded response</returns>
        public Newtonsoft.Json.Linq.JObject DELETE(string path, Dictionary<string, string> parameters)
        {
        ...
        /// <param name="headers">The request headers</param>
        /// <returns>The JSON-decoded response</returns>
        public Newtonsoft.Json.Linq.JObject DELETE(string path, Dictionary<string, string> parameters, Dictionary<string, string> headers)
        {
            string url = PathJoin(this.baseUrl, this.version, this.PracticeID, path);
            string query = "";
            if (parameters != null)
